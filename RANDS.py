...
#Sequentially run each configuration as a subprocess (ensures clean slate for compute), create/clear temporary directories, catch and exit on subprocess exceptions
